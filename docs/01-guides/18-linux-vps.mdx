...
![PuTTYgen Generate](/putty-gen/f0de356b082d892b5e5d45ce7995544c.png)

Move the mouse until a key is generated:

![PuTTYgen Randomness](/putty-gen/d6d652162d95b98cbd2b4d34eb30a5c1.png)

Change the Key comment to `nrgstaker`.

Clic `Save private key`:

![PuTTYgen Save Key](/putty-gen/83d201c86df786d5a1628dd10b2a939a.png)

Click `Yes` when the warning pops up:

![PuTTYgen Without Passphrase](/putty-gen/4f71c9485a3e904fc40f7da0db867a19.png)

Create a `New Folder` called `c:\energi3`. Save the private key in the folder:

![PuTTYgen Folder](/putty-gen/b957ece83d899bd029880bf9f32784f5.png)

Right click over the public key box and scroll down to `Select All`:

![PuTTYgen Select All](/putty-gen/de0f691a79e872c3372e7d1c94620b98.png)

Right click over the public key box and scroll down to `Copy`:

![PuTTYgen Copy](/putty-gen/28f5e4b840bc37625b11491132fea88f.png)

Exit PuTTY Key Generator:

![PuTTYgen Exit](/putty-gen/f945cc8408e802f4d07b06b54b6906db.png)
