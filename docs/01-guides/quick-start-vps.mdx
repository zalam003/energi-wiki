...
**2.1.1 -** Download the Energi Core Node Installer for Windows from the [Downloads Page](/downloads/core-node#windows). Once the download is complete, run the installer file and wait for it to finish installing the Energi Core Node.
